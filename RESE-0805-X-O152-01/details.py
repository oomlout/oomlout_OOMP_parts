...
newPart.addTag('oompID','RESE-0805-X-O152-01')
newPart.addTag('name','SMD (0805) 1.5k Ohm Resistor')
newPart.addTag('hexID','R85152')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O152-01")
