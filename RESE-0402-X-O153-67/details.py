...
newPart.addTag('oompID','RESE-0402-X-O153-67')
newPart.addTag('name','SMD (0402) 15k Ohm Resistor 1%')
newPart.addTag('hexID','R42153A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O153-67")
