...
newPart.addTag('index','4528')
newPart.addTag('oompID','RESE-W04-X-O682-01')
newPart.addTag('name','1/4 Watt 6.8k Ohm Resistor')
newPart.addTag('hexID','R4682')
newPart.addTag('oompSort','0W040006800')
...
newPart.addTag('colorBand1','BLUE')
newPart.addTag('colorBand2','GRAY')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O682-01")
