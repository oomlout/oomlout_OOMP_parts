...
pins = 6
newPart.addTag('oompID','HEAS-I01-X-PI06-01')
newPart.addTag('name','2.54 mm 6 Pin Female Header')
newPart.addTag('hexID','HF06')
...
newPart = OOMPtags.addTags(newPart,"HEAS-I01-X-PI06-01",pins = 6)
