...
pitch = 2.54 
newPart.addTag('index','3974')
newPart.addTag('oompID','LEDS-10-Y-FROS-01')
newPart.addTag('name','10 mm Frosted Yellow LED')
newPart.addTag('hexID','L10Y')
newPart.addTag('oompSort','1010Y')
...
newPart.addTag('ooWavelength','590 nm')
...
newPart = OOMPtags.addTags(newPart,"LEDS-10-Y-FROS-01",pitch = 2.54 )
