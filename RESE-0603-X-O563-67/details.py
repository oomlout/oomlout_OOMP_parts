...
newPart.addTag('oompID','RESE-0603-X-O563-67')
newPart.addTag('name','SMD (0603) 56k Ohm Resistor 1%')
newPart.addTag('hexID','R6563A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O563-67")
