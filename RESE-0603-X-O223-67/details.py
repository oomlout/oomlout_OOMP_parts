...
newPart.addTag('oompID','RESE-0603-X-O223-67')
newPart.addTag('name','SMD (0603) 22k Ohm Resistor 1%')
newPart.addTag('hexID','R6223A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O223-67")
