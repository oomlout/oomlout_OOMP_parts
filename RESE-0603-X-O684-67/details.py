...
newPart.addTag('oompID','RESE-0603-X-O684-67')
newPart.addTag('name','SMD (0603) 680k Ohm Resistor 1%')
newPart.addTag('hexID','R6684A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O684-67")
