...
newPart.addTag('oompID','LEDS-05-G-TINT-01')
newPart.addTag('name','5 mm Tinted Green LED')
newPart.addTag('hexID','LT5G')
newPart.addTag('oompSort','0505ZTINTG')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-G-TINT-01")
