...
newPart.addTag('index','4147')
newPart.addTag('oompID','RESE-W04-X-O101-01')
newPart.addTag('name','1/4 Watt 100 Ohm Resistor')
newPart.addTag('hexID','R4101')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O101-01")
