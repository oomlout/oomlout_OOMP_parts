...
newPart.addTag('oompDesc','PI2X10')
newPart.addTag('oompIndex','RS')
newPart.addTag('oompVersion','999')
newPart.addTag('hexID','HRS2X10')
...
newPart.addTag('numPins','20')
newPart.addTag('numRows','2')
newPart.addTag('oompFootprint','HEAD-I01-X-PI2x10-RS')
newPart = OOMPtags.addTags(newPart,"HEAD-I01-X-PI2X10-RS",pitch = 2.54 )
