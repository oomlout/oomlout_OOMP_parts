...
newPart.addTag('oompID','TRNN-SO23-X-A02D-01')
newPart.addTag('name','SMD (SOT-23) 200 mA NPN Transistor')
newPart.addTag('hexID','TNS22D')
...
newPart.addTag('ooPackageMarking','1AM')
newPart.addTag('ooDesignator','Q1')
newPart = OOMPtags.addTags(newPart,"TRNN-SO23-X-A02D-01")
