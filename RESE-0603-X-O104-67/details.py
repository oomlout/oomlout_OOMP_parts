...
newPart.addTag('oompID','RESE-0603-X-O104-67')
newPart.addTag('name','SMD (0603) 100k Ohm Resistor 1%')
newPart.addTag('hexID','R6104A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O104-67")
