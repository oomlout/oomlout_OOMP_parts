...
newPart.addTag('oompID','RESE-0805-X-O202-01')
newPart.addTag('hexID','R85202')
newPart.addTag('ooPackageMarking','202')
newPart.addTag('oompDesc','O202')
newPart.addTag('name','SMD (0805) 2k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O202-01")
