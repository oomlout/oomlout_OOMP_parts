...
newPart.addTag('oompID','RESE-0402-X-O203-01')
newPart.addTag('name','SMD (0402) 20k Ohm Resistor')
newPart.addTag('hexID','R42203')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O203-01")
