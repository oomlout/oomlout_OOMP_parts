...
newPart.addTag('oompID','RESE-0805-X-O105-67')
newPart.addTag('name','SMD (0805) 1M Ohm Resistor 1%')
newPart.addTag('hexID','R85105A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O105-67")
