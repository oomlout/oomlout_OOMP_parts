...
newPart.addTag('oompID','RESE-0805-X-O201-67')
newPart.addTag('name','SMD (0805) 200 Ohm Resistor 1%')
newPart.addTag('hexID','R85201A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O201-67")
