...
newPart.addTag('oompID','RESE-0805-X-O473-67')
newPart.addTag('name','SMD (0805) 47k Ohm Resistor 1%')
newPart.addTag('hexID','R85473A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O473-67")
