...
newPart.addTag('oompID','RESE-0402-X-O514-67')
newPart.addTag('name','SMD (0402) 510k Ohm Resistor 1%')
newPart.addTag('hexID','R42514A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O514-67")
