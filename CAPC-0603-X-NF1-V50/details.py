...
newPart.addTag('oompID','CAPC-0603-X-NF1-V50')
newPart.addTag('name','SMD (0603) 1 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6N001')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-NF1-V50")
