...
newPart.addTag('oompID','RESE-0402-X-O514-01')
newPart.addTag('name','SMD (0402) 510k Ohm Resistor')
newPart.addTag('hexID','R42514')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O514-01")
