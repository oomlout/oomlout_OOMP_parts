...
newPart.addTag('oompID','RESE-0603-X-O203-01')
newPart.addTag('name','SMD (0603) 20k Ohm Resistor')
newPart.addTag('ooPackageMarking','203')
newPart.addTag('hexID','R6203')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O203-01")
