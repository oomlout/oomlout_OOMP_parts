...
newPart.addTag('oompID','RESE-0603-X-O683-67')
newPart.addTag('name','SMD (0603) 68k Ohm Resistor 1%')
newPart.addTag('hexID','R6683A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O683-67")
