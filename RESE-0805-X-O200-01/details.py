...
newPart.addTag('oompID','RESE-0805-X-O200-01')
newPart.addTag('name','SMD (0805) 20 Ohm Resistor')
newPart.addTag('hexID','R85200')
newPart.addTag('ooPackageMarking','200')
newPart.addTag('oompDesc','O200')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O200-01")
