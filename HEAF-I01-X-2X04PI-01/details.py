...
pins = 2*4
newPart.addTag('oompID','HEAF-I01-X-2X04PI-01')
newPart.addTag('name','2.54 mm 8 Pin (2x4) Female Header')
newPart.addTag('hexID','HFX4')
newPart.addTag('oompSort','HEAF012X04PI')
...
newPart = OOMPtags.addTags(newPart,"HEAF-I01-X-2X04PI-01",pins = 2*4)
