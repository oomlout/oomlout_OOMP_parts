...
newPart.addTag('oompID','RESE-0603-X-O563-01')
newPart.addTag('name','SMD (0603) 56k Ohm Resistor')
newPart.addTag('hexID','R6563')
newPart.addTag('ooPackageMarking','563')
newPart.addTag('oompDesc','O563')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O563-01")
