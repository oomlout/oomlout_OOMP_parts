...
newPart.addTag('oompID','RESE-0805-X-O301-67')
newPart.addTag('name','SMD (0805) 300 Ohm Resistor 1%')
newPart.addTag('hexID','R85301A')
newPart.addTag('oompDesc','O301')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O301-67")
