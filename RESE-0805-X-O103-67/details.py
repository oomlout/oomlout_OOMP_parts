...
newPart.addTag('oompID','RESE-0805-X-O103-67')
newPart.addTag('hexID','R85103A')
newPart.addTag('oompDesc','O103')
newPart.addTag('name','SMD (0805) 10k Ohm Resistor 1%')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O103-67")
