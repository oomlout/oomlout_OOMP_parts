...
newPart.addTag('oompID','CAPC-0402-X-UF1-V10')
newPart.addTag('name','SMD (0402) 1 uF Capacitor (Ceramic) 10v')
newPart.addTag('hexID','C42U001')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','UF1')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-UF1-V10")
