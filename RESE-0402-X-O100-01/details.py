...
newPart.addTag('oompID','RESE-0402-X-O100-01')
newPart.addTag('hexID','R42100')
newPart.addTag('oompDesc','O100')
newPart.addTag('name','SMD (0402) 10 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O100-01")
