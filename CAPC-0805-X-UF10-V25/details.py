...
newPart.addTag('oompID','CAPC-0805-X-UF10-V25')
newPart.addTag('name','SMD (0805) 10 uF Capacitor (Ceramic) 25v')
newPart.addTag('hexID','C85U010')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0805-X-UF10-V25")
