...
newPart.addTag('oompID','RESE-0603-X-O202-01')
newPart.addTag('name','SMD (0603) 2k Ohm Resistor')
newPart.addTag('hexID','R6202')
newPart.addTag('ooPackageMarking','202')
newPart.addTag('oompDesc','O202')
newPart.addTag('oompSort','RESE0603O202')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O202-01")
