...
newPart.addTag('oompID','RESE-0402-X-O100-67')
newPart.addTag('hexID','R42100A')
newPart.addTag('oompDesc','O100')
newPart.addTag('name','SMD (0402) 10 Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O100')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O100-67")
