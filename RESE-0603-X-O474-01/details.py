...
newPart.addTag('oompID','RESE-0603-X-O474-01')
newPart.addTag('name','SMD (0603) 470k Ohm Resistor')
newPart.addTag('hexID','R6474')
newPart.addTag('ooPackageMarking','474')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O474-01")
