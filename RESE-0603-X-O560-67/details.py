...
newPart.addTag('oompID','RESE-0603-X-O560-67')
newPart.addTag('name','SMD (0603) 56 Ohm Resistor 1%')
newPart.addTag('hexID','R6560A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O560-67")
