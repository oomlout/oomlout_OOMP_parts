...
newPart.addTag('index','4152')
newPart.addTag('oompID','RESE-W04-X-O222-01')
newPart.addTag('name','1/4 Watt 2.2k Ohm Resistor')
newPart.addTag('hexID','R4222')
newPart.addTag('oompSort','0W040002200')
...
newPart.addTag('colorBand1','RED')
newPart.addTag('colorBand2','RED')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O222-01")
