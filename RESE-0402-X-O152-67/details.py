...
newPart.addTag('oompID','RESE-0402-X-O152-67')
newPart.addTag('name','SMD (0402) 1.5k Ohm Resistor 1%')
newPart.addTag('hexID','R42152A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O152-67")
