...
newPart.addTag('oompID','RESE-0402-X-O303-01')
newPart.addTag('name','SMD (0402) 30k Ohm Resistor')
newPart.addTag('hexID','R42303')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O303-01")
