...
newPart.addTag('oompID','RESE-0402-X-O472-01')
newPart.addTag('hexID','R42472')
newPart.addTag('oompDesc','O472')
newPart.addTag('name','SMD (0402) 4.7k Ohm Resistor')
newPart.addTag('oompSort','RESE0402O472')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O472-01")
