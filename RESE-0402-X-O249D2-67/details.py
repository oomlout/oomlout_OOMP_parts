...
newPart.addTag('oompID','RESE-0402-X-O249D2-67')
newPart.addTag('name','SMD (0402) 2.49 Ohm Resistor 1%')
newPart.addTag('hexID','R42249D2A')
newPart.addTag('oompDesc','O249D2')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O249D2-67")
