...
newPart.addTag('oompID','RESE-0805-X-O472-01')
newPart.addTag('hexID','R85472')
newPart.addTag('ooPackageMarking','472')
newPart.addTag('oompDesc','O472')
newPart.addTag('name','SMD (0805) 4.7k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O472-01")
