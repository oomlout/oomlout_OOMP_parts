...
pitch = 2.54
pins = 8
newPart.addTag('oompID','HEAD-I01-W-PI08-01')
newPart.addTag('name','2.54 mm 8 Pin White Header')
newPart.addTag('hexID','H08W')
...
newPart = OOMPtags.addTags(newPart,"HEAD-I01-W-PI08-01",pitch = 2.54,pins = 8)
