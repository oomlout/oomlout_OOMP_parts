...
newPart.addTag('oompID','CAPC-0603-X-PF27-V50')
newPart.addTag('name','SMD (0603) 27 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P027')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF27-V50")
