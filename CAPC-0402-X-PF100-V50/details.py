...
newPart.addTag('oompID','CAPC-0402-X-PF100-V50')
newPart.addTag('name','SMD (0402) 100 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42P100')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-PF100-V50")
