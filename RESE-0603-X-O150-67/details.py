...
newPart.addTag('oompID','RESE-0603-X-O150-67')
newPart.addTag('name','SMD (0603) 15 Ohm Resistor 1%')
newPart.addTag('hexID','R6150A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O160-67")
