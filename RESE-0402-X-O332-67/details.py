...
newPart.addTag('oompID','RESE-0402-X-O332-67')
newPart.addTag('name','SMD (0402) 3.3k Ohm Resistor 1%')
newPart.addTag('hexID','R42332A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O332-67")
