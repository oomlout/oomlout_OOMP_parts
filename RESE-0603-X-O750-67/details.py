...
newPart.addTag('oompID','RESE-0603-X-O750-67')
newPart.addTag('name','SMD (0603) 75 Ohm Resistor 1%')
newPart.addTag('hexID','R6750A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O750-67")
