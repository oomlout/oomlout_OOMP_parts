...
newPart.addTag('oompID','RESE-0402-X-O471-67')
newPart.addTag('name','SMD (0402) 470 Ohm Resistor 1%')
newPart.addTag('hexID','R42471A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O471-67")
