...
newPart.addTag('oompID','RESE-0603-X-O751-01')
newPart.addTag('name','SMD (0603) 750 Ohm Resistor')
newPart.addTag('hexID','R6751')
newPart.addTag('ooPackageMarking','751')
newPart.addTag('oompDesc','O751')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O751-01")
