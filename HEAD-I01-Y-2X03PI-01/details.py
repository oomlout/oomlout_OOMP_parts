...
pitch = 2.54
pins = 6
newPart.addTag('oompID','HEAD-I01-Y-2X03PI-01')
newPart.addTag('name','2.54 mm 6 Pin (2x3) Yellow Header')
newPart.addTag('hexID','H2X03Y')
...
newPart.addTag('ooFootprint','OOMP-HEAD-I01-X-2X03PI-01')
newPart.addTag('ooDesignator','J1')
newPart = OOMPtags.addTags(newPart,"HEAD-I01-Y-2X03PI-01",pitch = 2.54,pins = 6)
