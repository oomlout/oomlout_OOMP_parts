...
newPart.addTag('oompID','RESE-0603-X-O241-01')
newPart.addTag('name','SMD (0603) 240 Ohm Resistor')
newPart.addTag('hexID','R6241')
newPart.addTag('ooPackageMarking','241')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O241')
