...
newPart.addTag('oompID','CAPC-0402-X-NF100-V25')
newPart.addTag('name','SMD (0402) 100 nF Capacitor (Ceramic) 25v')
newPart.addTag('hexID','C42N100V25')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-NF100-V25")
