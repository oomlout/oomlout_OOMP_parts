...
newPart.addTag('oompID','RESE-0603-X-O000-67')
newPart.addTag('name','SMD (0603) 0 Ohm Resistor 1%')
newPart.addTag('hexID','R6000A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O000-67")
