...
newPart.addTag('oompID','RESE-0402-X-O105-01')
newPart.addTag('hexID','R42105')
newPart.addTag('oompDesc','O105')
newPart.addTag('name','SMD (0402) 1M Ohm Resistor')
newPart.addTag('oompSort','RESE0402O105')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O105-01")
