...
newPart.addTag('oompID','RESE-0402-X-O221-67')
newPart.addTag('name','SMD (0402) 220 Ohm Resistor 1%')
newPart.addTag('hexID','R42221A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O221-67")
