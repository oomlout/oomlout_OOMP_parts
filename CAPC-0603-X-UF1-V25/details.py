...
newPart.addTag('oompID','CAPC-0603-X-UF1-V25')
newPart.addTag('name','SMD (0603) 1 uF Capacitor (Ceramic) 25v')
newPart.addTag('hexID','C6U001')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-UF1-V25")
