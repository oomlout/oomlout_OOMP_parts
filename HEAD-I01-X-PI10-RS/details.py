...
pins = 2
newPart.addTag('oompID','HEAD-I01-X-PI10-RS')
newPart.addTag('name','2.54 mm 10 Pin Header Right Angle (SMD)')
...
newPart.addTag('oompIden','variable;pins;10')
...
newPart.addTag('schematicSymbol','HEAD-XX-X-PI10-XX')
newPart.addTag('pcbFootprint','HEAD-I01-X-PI10-RS')
newPart = OOMPtags.addTags(newPart,"HEAD-I01-X-PI10-RS",pins = 2)
