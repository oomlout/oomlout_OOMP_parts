...
newPart.addTag('oompID','RESE-0603-X-O512-67')
newPart.addTag('name','SMD (0603) 5.1k Ohm Resistor 1%')
newPart.addTag('hexID','R6512A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O512-67")
