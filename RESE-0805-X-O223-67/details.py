...
newPart.addTag('oompID','RESE-0805-X-O223-67')
newPart.addTag('name','SMD (0805) 22k Ohm Resistor 1%')
newPart.addTag('hexID','R85223A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O223-67")
