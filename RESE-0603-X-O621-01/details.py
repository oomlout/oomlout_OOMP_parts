...
newPart.addTag('oompID','RESE-0603-X-O621-01')
newPart.addTag('name','SMD (0603) 620 Ohm Resistor')
newPart.addTag('hexID','R6621')
newPart.addTag('ooPackageMarking','621')
newPart.addTag('oompDesc','O621')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O621-01")
