...
newPart.addTag('oompID','RESE-0402-X-O203-67')
newPart.addTag('name','SMD (0402) 20k Ohm Resistor 1%')
newPart.addTag('hexID','R42203A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O203-67")
