...
newPart.addTag('oompID','CAPC-0603-X-NF33-V50')
newPart.addTag('name','SMD (0603) 33 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6N033')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','NF33')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-NF33-V50")
