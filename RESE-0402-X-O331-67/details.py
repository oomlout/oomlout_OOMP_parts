...
newPart.addTag('oompID','RESE-0402-X-O331-67')
newPart.addTag('hexID','R42331A')
newPart.addTag('oompDesc','O331')
newPart.addTag('name','SMD (0402) 330 Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O331')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O331-67")
