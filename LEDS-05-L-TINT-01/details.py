...
newPart.addTag('oompID','LEDS-05-L-TINT-01')
newPart.addTag('name','5 mm Tinted Blue LED')
newPart.addTag('hexID','LT5L')
newPart.addTag('oompSort','0505ZTINTL')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-L-TINT-01")
