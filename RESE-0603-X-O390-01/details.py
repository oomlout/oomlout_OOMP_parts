...
newPart.addTag('oompID','RESE-0603-X-O390-01')
newPart.addTag('name','SMD (0603) 39 Ohm Resistor')
newPart.addTag('hexID','R6390')
newPart.addTag('ooPackageMarking','390')
newPart.addTag('oompSort','RESE0603O390')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O390')
