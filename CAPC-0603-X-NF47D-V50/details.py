...
newPart.addTag('oompID','CAPC-0603-X-NF47D-V50')
newPart.addTag('name','SMD (0603) 4.7 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6N004')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-NF47D-V50")
