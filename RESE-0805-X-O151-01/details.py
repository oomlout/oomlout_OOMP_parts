...
newPart.addTag('oompID','RESE-0805-X-O151-01')
newPart.addTag('name','SMD (0805) 150 Ohm Resistor')
newPart.addTag('hexID','R85151')
newPart.addTag('ooPackageMarking','151')
newPart.addTag('oompDesc','O151')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O151-01")
