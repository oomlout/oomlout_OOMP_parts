...
newPart.addTag('oompID','RESE-0805-X-O470-67')
newPart.addTag('name','SMD (0805) 47 Ohm Resistor 1%')
newPart.addTag('hexID','R85470A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O470-67")
