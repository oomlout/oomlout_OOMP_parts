...
newPart.addTag('oompID','CAPC-0805-X-UF22D-V25')
newPart.addTag('name','SMD (0805) 2.2 uF Capacitor (Ceramic) 25v')
newPart.addTag('hexID','C85U002')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0805-X-UF22D-V25")
