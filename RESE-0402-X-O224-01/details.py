...
newPart.addTag('oompID','RESE-0402-X-O224-01')
newPart.addTag('name','SMD (0402) 220k Ohm Resistor')
newPart.addTag('hexID','R42224')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O224-01")
