...
newPart.addTag('oompID','RESE-0805-X-O122-67')
newPart.addTag('name','SMD (0805) 1.2k Ohm Resistor 1%')
newPart.addTag('hexID','R85122A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O122-67")
