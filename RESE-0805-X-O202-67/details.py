...
newPart.addTag('oompID','RESE-0805-X-O202-67')
newPart.addTag('name','SMD (0805) 2k Ohm Resistor 1%')
newPart.addTag('hexID','R85202A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O202-67")
