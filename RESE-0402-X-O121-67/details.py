...
newPart.addTag('oompID','RESE-0402-X-O121-67')
newPart.addTag('name','SMD (0402) 120 Ohm Resistor 1%')
newPart.addTag('hexID','R42121A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O121-67")
