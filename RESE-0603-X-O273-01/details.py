...
newPart.addTag('oompID','RESE-0603-X-O273-01')
newPart.addTag('hexID','R6273')
newPart.addTag('name','SMD (0603) 28k Ohm Resistor')
newPart.addTag('ooPackageMarking','273')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O273')
