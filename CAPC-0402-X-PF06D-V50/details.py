...
newPart.addTag('oompID','CAPC-0402-X-PF06D-V50')
newPart.addTag('name','SMD (0402) 0.6 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42P006D')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF06D')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-PF06D-V50")
