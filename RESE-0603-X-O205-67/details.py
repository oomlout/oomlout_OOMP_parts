...
newPart.addTag('oompID','RESE-0603-X-O205-67')
newPart.addTag('name','SMD (0603) 2.0M Ohm Resistor 1%')
newPart.addTag('hexID','R6205A')
newPart.addTag('oompDesc','O205')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O205-67")
