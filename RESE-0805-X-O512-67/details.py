...
newPart.addTag('oompID','RESE-0805-X-O512-67')
newPart.addTag('name','SMD (0805) 5.1k Ohm Resistor 1%')
newPart.addTag('hexID','R85512A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O512-67")
