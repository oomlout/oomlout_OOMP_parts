...
newPart.addTag('oompID','RESE-0805-X-O680-01')
newPart.addTag('name','SMD (0805) 68 Ohm Resistor')
newPart.addTag('ooPackageMarking','680')
newPart.addTag('hexID','R85680')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O680-01")
