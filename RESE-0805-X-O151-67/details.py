...
newPart.addTag('oompID','RESE-0805-X-O151-67')
newPart.addTag('name','SMD (0805) 150 Ohm Resistor 1%')
newPart.addTag('hexID','R85151A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O151-67")
