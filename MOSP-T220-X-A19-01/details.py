...
pitch = 2.54 
newPart.addTag('oompID','MOSP-T220-X-A19-01')
newPart.addTag('name','TO-220 19 Amp P-Ch. MOSFET')
newPart.addTag('oompSort','')
newPart.addTag('oompType','MOSP')
newPart.addTag('oompSize','T220')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','A19')
newPart.addTag('oompIndex','01')
newPart.addTag('oompVersion','999')
newPart.addTag('hexID','MP220A19')
...
newPart = OOMPtags.addTags(newPart,"MOSP-T220-X-A19-01",pitch = 2.54 )
