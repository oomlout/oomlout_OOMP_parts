...
newPart.addTag('oompID','RESE-0805-X-O123-01')
newPart.addTag('name','SMD (0805) 12k Ohm Resistor')
newPart.addTag('hexID','R85123')
newPart.addTag('ooPackageMarking','123')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O123-01")
