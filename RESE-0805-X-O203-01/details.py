...
newPart.addTag('oompID','RESE-0805-X-O203-01')
newPart.addTag('name','SMD (0805) 20k Ohm Resistor')
newPart.addTag('hexID','R85203')
newPart.addTag('ooPackageMarking','203')
newPart.addTag('oompDesc','O203')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O203-01")
