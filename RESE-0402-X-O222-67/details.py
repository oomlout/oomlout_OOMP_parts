...
newPart.addTag('oompID','RESE-0402-X-O222-67')
newPart.addTag('name','SMD (0402) 2.2k Ohm Resistor 1%')
newPart.addTag('hexID','R42222A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O222-67")
