...
newPart.addTag('oompID','TRNN-SO23-X-A01D-01')
newPart.addTag('name','SMD (SOT-23) 100 mA NPN Transistor')
newPart.addTag('hexID','TNS21D')
...
newPart.addTag('ooPackageMarking','J6')
newPart.addTag('ooDesignator','Q1')
newPart = OOMPtags.addTags(newPart,"TRNN-SO23-X-A01D-01")
