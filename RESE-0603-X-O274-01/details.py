...
newPart.addTag('oompID','RESE-0603-X-O274-01')
newPart.addTag('name','SMD (0603) 280k Ohm Resistor')
newPart.addTag('hexID','R6274')
newPart.addTag('ooPackageMarking','274')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O274')
