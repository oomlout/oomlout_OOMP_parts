...
newPart.addTag('oompID','RESE-0603-X-O133-67')
newPart.addTag('name','SMD (0603) 13k Ohm Resistor 1%')
newPart.addTag('hexID','R6133A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O133-67")
