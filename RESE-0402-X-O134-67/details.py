...
newPart.addTag('oompID','RESE-0402-X-O134-67')
newPart.addTag('name','SMD (0402) 130k Ohm Resistor 1%')
newPart.addTag('hexID','R42134A')
newPart.addTag('oompDesc','O134')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O134-67")
