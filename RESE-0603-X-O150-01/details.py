...
newPart.addTag('oompID','RESE-0603-X-O150-01')
newPart.addTag('name','SMD (0603) 15 Ohm Resistor')
newPart.addTag('hexID','R6150')
newPart.addTag('ooPackageMarking','150')
newPart.addTag('oompDesc','O150')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O150-01")
