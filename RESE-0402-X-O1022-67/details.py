...
newPart.addTag('oompID','RESE-0402-X-O1022-67')
newPart.addTag('name','SMD (0402) 10.2k Ohm Resistor 1%')
newPart.addTag('hexID','R421022A')
newPart.addTag('oompDesc','O1022')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O1022-67")
