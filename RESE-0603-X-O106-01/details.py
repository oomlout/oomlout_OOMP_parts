...
newPart.addTag('oompID','RESE-0603-X-O106-01')
newPart.addTag('name','SMD (0603) 10M Ohm Resistor')
newPart.addTag('hexID','R6106')
newPart.addTag('ooPackageMarking','106')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O106-01")
