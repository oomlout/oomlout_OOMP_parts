...
newPart.addTag('oompID','RESE-0402-X-O181-67')
newPart.addTag('name','SMD (0402) 180 Ohm Resistor 1%')
newPart.addTag('hexID','R42181A')
newPart.addTag('oompDesc','O181')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O181-67")
