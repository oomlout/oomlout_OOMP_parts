...
newPart.addTag('oompID','RESE-0603-X-O102-67')
newPart.addTag('name','SMD (0603) 1k Ohm Resistor 1%')
newPart.addTag('hexID','R6102A')
newPart.addTag('oompDesc','O102')
newPart.addTag('oompSort','ZZZ06030001000')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O102-67")
