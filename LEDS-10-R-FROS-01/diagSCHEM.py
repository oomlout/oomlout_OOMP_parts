...
shiftX=50
shiftY=50
# TEMPLATE  template;LEDS-XXXX-X-XXXX-XX-schem
#  corTemplate;LEDS-XXXX-X-XXXX-XX-schem
...
shape = text(,(0,0),stroke_width=0.25,stroke='black',font_size='"10 mm Frosted Red LED"pt',font_family='Relief Single Line Outline',text_align='center',shape_inside=shape)
