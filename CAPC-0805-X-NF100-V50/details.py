...
newPart.addTag('oompID','CAPC-0805-X-NF100-V50')
newPart.addTag('name','SMD (0805) 100 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C85N100')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0805')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','NF100')
newPart.addTag('oompIndex','V50')
newPart.addTag('oompVersion','999')
newPart.addTag('ooWidth','1.25mm')
newPart.addTag('ooHeight','0.85mm')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0805-X-NF100-V50")
