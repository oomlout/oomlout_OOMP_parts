...
newPart.addTag('oompID','RESE-0805-X-O561-67')
newPart.addTag('name','SMD (0805) 560 Ohm Resistor 1%')
newPart.addTag('hexID','R85561A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O561-67")
