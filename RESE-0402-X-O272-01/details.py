...
newPart.addTag('oompID','RESE-0402-X-O272-01')
newPart.addTag('name','SMD (0402) 2.7k Ohm Resistor')
newPart.addTag('hexID','R42272')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O272-01")
