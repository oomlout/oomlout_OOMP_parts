...
newPart.addTag('oompID','RESE-0603-X-O221-01')
newPart.addTag('name','SMD (0603) 220 Ohm Resistor')
newPart.addTag('hexID','R6221')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O221-01")
