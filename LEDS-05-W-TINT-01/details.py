...
newPart.addTag('oompID','LEDS-05-W-TINT-01')
newPart.addTag('name','5 mm Tinted White LED')
newPart.addTag('hexID','LT5W')
newPart.addTag('oompSort','0505ZTINTW')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-W-TINT-01")
