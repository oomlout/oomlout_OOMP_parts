...
newPart.addTag('oompID','RESE-0603-X-O106-67')
newPart.addTag('name','SMD (0603) 10M Ohm Resistor 1%')
newPart.addTag('hexID','R6106A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O106-67")
