...
newPart.addTag('oompID','RESE-0603-X-O100-01')
newPart.addTag('name','SMD (0603) 10 Ohm Resistor')
newPart.addTag('hexID','R6100')
newPart.addTag('ooPackageMarking','100')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O100-01")
