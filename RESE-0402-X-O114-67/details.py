...
newPart.addTag('oompID','RESE-0402-X-O114-67')
newPart.addTag('name','SMD (0402) 120k Ohm Resistor 1%')
newPart.addTag('hexID','R42114A')
newPart.addTag('oompDesc','O114')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O114-67")
