...
newPart.addTag('oompID','RESE-0603-X-O201-67')
newPart.addTag('name','SMD (0603) 200 Ohm Resistor 1%')
newPart.addTag('hexID','R6201A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O201-67")
