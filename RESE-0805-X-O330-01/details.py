...
newPart.addTag('oompID','RESE-0805-X-O330-01')
newPart.addTag('name','SMD (0805) 33 Ohm Resistor')
newPart.addTag('hexID','R85330')
newPart.addTag('ooPackageMarking','330')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O330-01")
