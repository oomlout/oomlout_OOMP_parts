...
newPart.addTag('oompID','RESE-0603-X-O151-67')
newPart.addTag('name','SMD (0603) 150 Ohm Resistor 1%')
newPart.addTag('hexID','R6151A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O151-67")
