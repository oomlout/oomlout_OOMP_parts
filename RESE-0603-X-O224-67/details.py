...
newPart.addTag('oompID','RESE-0603-X-O224-67')
newPart.addTag('name','SMD (0603) 220k Ohm Resistor 1%')
newPart.addTag('hexID','R6224A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O224-67")
