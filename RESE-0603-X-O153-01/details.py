...
newPart.addTag('oompID','RESE-0603-X-O153-01')
newPart.addTag('name','SMD (0603) 16k Ohm Resistor')
newPart.addTag('hexID','R6153')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O153-01")
