...
newPart.addTag('oompID','RESE-0603-X-O203-67')
newPart.addTag('name','SMD (0603) 20k Ohm Resistor 1%')
newPart.addTag('hexID','R6203A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O203-67")
