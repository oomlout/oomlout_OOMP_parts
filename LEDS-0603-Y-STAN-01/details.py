...
newPart.addTag('oompID','LEDS-0603-Y-STAN-01')
newPart.addTag('name','SMD (0603) Yellow LED')
newPart.addTag('hexID','L6Y')
...
newPart = OOMPtags.addTags(newPart,"LEDS-0603-Y-STAN-01")
