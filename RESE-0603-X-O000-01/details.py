...
newPart.addTag('oompID','RESE-0603-X-O000-01')
newPart.addTag('name','SMD (0603) 0 Ohm Resistor')
newPart.addTag('hexID','R6000')
newPart.addTag('ooPackageMarking','0')
newPart.addTag('oompDesc','O000')
newPart.addTag('oompSort','06030000000')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O000-01")
