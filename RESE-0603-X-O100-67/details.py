...
newPart.addTag('oompID','RESE-0603-X-O100-67')
newPart.addTag('name','SMD (0603) 10 Ohm Resistor 1%')
newPart.addTag('hexID','R6100A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O100-67")
