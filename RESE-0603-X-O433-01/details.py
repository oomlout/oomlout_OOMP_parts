...
newPart.addTag('oompID','RESE-0603-X-O433-01')
newPart.addTag('name','SMD (0603) 43k Ohm Resistor')
newPart.addTag('hexID','R6433')
newPart.addTag('ooPackageMarking','433')
newPart.addTag('oompDesc','O433')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O433-01")
