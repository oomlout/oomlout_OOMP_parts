...
newPart.addTag('oompID','RESE-0805-X-O221-01')
newPart.addTag('hexID','R85221')
newPart.addTag('ooPackageMarking','221')
newPart.addTag('oompDesc','O221')
newPart.addTag('name','SMD (0805) 220 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O221-01")
