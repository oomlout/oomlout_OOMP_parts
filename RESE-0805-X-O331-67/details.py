...
newPart.addTag('oompID','RESE-0805-X-O331-67')
newPart.addTag('name','SMD (0805) 330 Ohm Resistor 1%')
newPart.addTag('hexID','R85331A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O331-67")
