...
newPart.addTag('oompID','RESE-0603-X-O4022-67')
newPart.addTag('name','SMD (0603) 40k Ohm Resistor 1%')
newPart.addTag('hexID','R6402')
newPart.addTag('ooPackageMarking','402')
newPart.addTag('oompDesc','O402')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O4022')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O402-67")
