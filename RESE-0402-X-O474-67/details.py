...
newPart.addTag('oompID','RESE-0402-X-O474-67')
newPart.addTag('hexID','R42474A')
newPart.addTag('oompDesc','O474')
newPart.addTag('name','SMD (0402) 470k Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O474')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O474-67")
