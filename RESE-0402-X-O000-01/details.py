...
newPart.addTag('oompID','RESE-0402-X-O000-01')
newPart.addTag('name','SMD (0402) 0 Ohm Resistor')
newPart.addTag('hexID','R42000')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O000-01")
