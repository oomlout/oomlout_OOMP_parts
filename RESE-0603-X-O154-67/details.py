...
newPart.addTag('oompID','RESE-0603-X-O154-67')
newPart.addTag('name','SMD (0603) 150k Ohm Resistor 1%')
newPart.addTag('hexID','R6154A')
newPart.addTag('oompDesc','O154')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O154-67")
