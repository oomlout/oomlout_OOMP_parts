...
newPart.addTag('oompID','RESE-0805-X-O204-67')
newPart.addTag('name','SMD (0805) 200k Ohm Resistor 1%')
newPart.addTag('hexID','R85204A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O204-67")
