...
newPart.addTag('oompID','RESE-0805-X-O122-01')
newPart.addTag('name','SMD (0805) 1.2k Ohm Resistor')
newPart.addTag('hexID','R85122')
newPart.addTag('ooPackageMarking','122')
newPart.addTag('oompDesc','O122')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O122-01")
