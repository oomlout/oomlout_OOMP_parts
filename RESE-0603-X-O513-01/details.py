...
newPart.addTag('oompID','RESE-0603-X-O513-01')
newPart.addTag('name','SMD (0603) 51k Ohm Resistor')
newPart.addTag('hexID','R6513')
newPart.addTag('ooPackageMarking','513')
newPart.addTag('oompDesc','O513')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O513-01")
