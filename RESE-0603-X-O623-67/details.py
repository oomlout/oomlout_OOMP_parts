...
newPart.addTag('oompID','RESE-0603-X-O623-67')
newPart.addTag('name','SMD (0603) 62k Ohm Resistor 1%')
newPart.addTag('hexID','R6623A')
newPart.addTag('oompDesc','O623')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O623-67")
