...
newPart.addTag('oompID','RESE-0603-X-O683-01')
newPart.addTag('name','SMD (0603) 68k Ohm Resistor')
newPart.addTag('hexID','R6683')
newPart.addTag('ooPackageMarking','683')
newPart.addTag('oompDesc','O683')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O683-01")
