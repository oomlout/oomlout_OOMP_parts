...
newPart.addTag('oompID','RESE-0603-X-O620-01')
newPart.addTag('name','SMD (0603) 62 Ohm Resistor')
newPart.addTag('hexID','R6620')
newPart.addTag('ooPackageMarking','620')
newPart.addTag('oompDesc','O620')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O620-01")
