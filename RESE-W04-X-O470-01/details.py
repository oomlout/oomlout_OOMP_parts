...
newPart.addTag('index','4158')
newPart.addTag('oompID','RESE-W04-X-O470-01')
newPart.addTag('name','1/4 Watt 47 Ohm Resistor')
newPart.addTag('hexID','R4470')
newPart.addTag('oompSort','0W040000047')
...
newPart.addTag('colorBand3','BLACK')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O470-01")
