...
newPart.addTag('oompID','RESE-0805-X-O510-67')
newPart.addTag('name','SMD (0805) 51 Ohm Resistor 1%')
newPart.addTag('hexID','R85510A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O510-67")
