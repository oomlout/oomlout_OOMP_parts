...
newPart.addTag('oompID','RESE-0603-X-O224-01')
newPart.addTag('name','SMD (0603) 220k Ohm Resistor')
newPart.addTag('hexID','R6224')
newPart.addTag('ooPackageMarking','224')
newPart.addTag('oompDesc','O224')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O224-01")
