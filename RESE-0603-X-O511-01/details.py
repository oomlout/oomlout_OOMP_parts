...
newPart.addTag('oompID','RESE-0603-X-O511-01')
newPart.addTag('name','SMD (0603) 510 Ohm Resistor')
newPart.addTag('hexID','R6511')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O511-01")
