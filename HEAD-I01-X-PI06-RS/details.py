...
pins = 6
newPart.addTag('oompID','HEAD-I01-X-PI06-RS')
newPart.addTag('name','2.54 mm 6 Pin Header Right Angle (SMD)')
...
newPart.addTag('pcbFootprint','HEAD-I01-X-PI06-RS')
newPart = OOMPtags.addTags(newPart,"HEAD-I01-X-PI06-RS",pins = 6)
