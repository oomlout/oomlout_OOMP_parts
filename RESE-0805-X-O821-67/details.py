...
newPart.addTag('oompID','RESE-0805-X-O821-67')
newPart.addTag('name','SMD (0805) 820 Ohm Resistor 1%')
newPart.addTag('hexID','R85821A')
newPart.addTag('oompDesc','O821')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O821-67")
