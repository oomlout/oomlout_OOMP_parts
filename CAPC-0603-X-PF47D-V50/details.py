...
newPart.addTag('oompID','CAPC-0603-X-PF47D-V50')
newPart.addTag('name','SMD (0603) 4.7 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P004')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF47D')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF47D-V50")
