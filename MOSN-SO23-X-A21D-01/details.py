...
newPart.addTag('oompID','MOSN-SO23-X-A21D-01')
newPart.addTag('name','SMD (SOT-23) 2.1 Amp N-Ch. MOSFET')
newPart.addTag('hexID','MNS221D')
...
newPart.addTag('ooPackageMarking','S2')
newPart.addTag('ooDesignator','Q1')
newPart = OOMPtags.addTags(newPart,"MOSN-SO23-X-A21D-01")
