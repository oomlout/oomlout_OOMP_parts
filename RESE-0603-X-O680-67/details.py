...
newPart.addTag('oompID','RESE-0603-X-O680-67')
newPart.addTag('name','SMD (0603) 68 Ohm Resistor 1%')
newPart.addTag('hexID','R6680A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O680-67")
