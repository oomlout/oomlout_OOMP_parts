...
newPart.addTag('oompID','LEDS-05-O-TINT-01')
newPart.addTag('name','5 mm Tinted Orange LED')
newPart.addTag('hexID','LT5O')
newPart.addTag('oompSort','0505ZTINTO')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-O-TINT-01")
