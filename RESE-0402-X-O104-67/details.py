...
newPart.addTag('oompID','RESE-0402-X-O104-67')
newPart.addTag('hexID','R42104A')
newPart.addTag('oompDesc','O104')
newPart.addTag('name','SMD (0402) 100k Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O104')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O104-67")
