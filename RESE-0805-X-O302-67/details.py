...
newPart.addTag('oompID','RESE-0805-X-O302-67')
newPart.addTag('name','SMD (0805) 3k Ohm Resistor 1%')
newPart.addTag('hexID','R85302A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O302-67")
