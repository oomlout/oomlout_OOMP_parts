...
pitch = 2.54
pins = 6
newPart.addTag('oompID','HEAD-I01-L-2X03PI-01')
newPart.addTag('name','2.54 mm 6 Pin (2x3) Blue Header')
newPart.addTag('hexID','H2X03L')
...
newPart = OOMPtags.addTags(newPart,"HEAD-I01-L-2X03PI-01",pitch = 2.54,pins = 6)
