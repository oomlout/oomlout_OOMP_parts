...
newPart.addTag('oompID','RESE-0402-X-O222-01')
newPart.addTag('name','SMD (0402) 2.2k Ohm Resistor')
newPart.addTag('hexID','R42222')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O222-01")
