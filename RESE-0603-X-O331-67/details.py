...
newPart.addTag('oompID','RESE-0603-X-O331-67')
newPart.addTag('hexID','R6331A')
newPart.addTag('name','SMD (0603) 330 Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0603O331')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X--67")
