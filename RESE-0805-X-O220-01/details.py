...
newPart.addTag('oompID','RESE-0805-X-O220-01')
newPart.addTag('hexID','R85220')
newPart.addTag('ooPackageMarking','220')
newPart.addTag('oompDesc','O220')
newPart.addTag('name','SMD (0805) 22 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O220-01")
