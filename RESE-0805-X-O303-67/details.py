...
newPart.addTag('oompID','RESE-0805-X-O303-67')
newPart.addTag('name','SMD (0805) 30k Ohm Resistor 1%')
newPart.addTag('hexID','R85303A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O303-67")
