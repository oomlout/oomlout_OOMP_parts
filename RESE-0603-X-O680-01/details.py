...
newPart.addTag('oompID','RESE-0603-X-O680-01')
newPart.addTag('name','SMD (0603) 68 Ohm Resistor')
newPart.addTag('hexID','R6680')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O680-01")
