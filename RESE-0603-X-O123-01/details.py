...
newPart.addTag('oompID','RESE-0603-X-O123-01')
newPart.addTag('name','SMD (0603) 12k Ohm Resistor')
newPart.addTag('hexID','R6123')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O123-01")
