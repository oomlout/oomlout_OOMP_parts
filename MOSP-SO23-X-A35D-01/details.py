...
newPart.addTag('oompID','MOSP-SO23-X-A35D-01')
newPart.addTag('name','SMD (SOT-23) 3.5 Amp P-Ch. MOSFET')
newPart.addTag('hexID','MPS235D')
...
newPart = OOMPtags.addTags(newPart,"MOSP-SO23-X-A35D-01")
