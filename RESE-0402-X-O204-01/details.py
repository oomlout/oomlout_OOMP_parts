...
newPart.addTag('oompID','RESE-0402-X-O204-01')
newPart.addTag('name','SMD (0402) 200k Ohm Resistor')
newPart.addTag('hexID','R42204')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O204-01")
