...
pins = 10
newPart.addTag('oompID','HEAF-02-W-PI10-01')
newPart.addTag('name','2 mm 10 Pin White Female Header')
newPart.addTag('hexID','HF210W')
...
newPart.addTag('ooFootprint','OOMP-HEAD-02-X-PI10-01')
newPart.addTag('ooDesignator','J1')
newPart = OOMPtags.addTags(newPart,"HEAF-02-W-PI10-01",pins = 10)
