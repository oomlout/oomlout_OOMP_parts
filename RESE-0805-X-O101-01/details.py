...
newPart.addTag('oompID','RESE-0805-X-O101-01')
newPart.addTag('hexID','R85101')
newPart.addTag('ooPackageMarking','101')
newPart.addTag('oompDesc','O101')
newPart.addTag('name','SMD (0805) 100 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O101-01")
