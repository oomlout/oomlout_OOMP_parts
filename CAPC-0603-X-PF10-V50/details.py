...
newPart.addTag('oompID','CAPC-0603-X-PF10-V50')
newPart.addTag('name','SMD (0603) 10 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P010')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF10-V50")
