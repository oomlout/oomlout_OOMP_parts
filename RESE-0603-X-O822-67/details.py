...
newPart.addTag('oompID','RESE-0603-X-O822-67')
newPart.addTag('name','SMD (0603) 8.2k Ohm Resistor 1%')
newPart.addTag('hexID','R6822A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O822-67")
