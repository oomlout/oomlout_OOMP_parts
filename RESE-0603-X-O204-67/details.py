...
newPart.addTag('oompID','RESE-0603-X-O204-67')
newPart.addTag('name','SMD (0603) 200k Ohm Resistor 1%')
newPart.addTag('hexID','R6204A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O204-67")
