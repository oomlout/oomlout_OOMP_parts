...
pins = 2
newPart.addTag('oompID','HEAD-I01-X-PI12-RS')
newPart.addTag('name','2.54 mm 12 Pin Header Right Angle (SMD)')
newPart.addTag('oompType','HEAD')
newPart.addTag('oompSize','I01')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PI12')
