...
newPart.addTag('oompID','RESE-0603-X-O113-67')
newPart.addTag('name','SMD (0603) 11k Ohm Resistor 1%')
newPart.addTag('hexID','R6113A')
newPart.addTag('oompDesc','O113')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O113-67")
