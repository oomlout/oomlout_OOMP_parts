...
newPart.addTag('oompID','CAPC-0805-X-UF22-V63D')
newPart.addTag('name','SMD (0805) 22 uF Capacitor (Ceramic) 6.3v')
newPart.addTag('hexID','C85U022')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0805-X-UF22-V63D")
