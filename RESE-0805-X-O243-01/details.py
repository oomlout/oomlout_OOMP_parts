...
newPart.addTag('oompID','RESE-0805-X-O243-01')
newPart.addTag('name','SMD (0805) 24k Ohm Resistor')
newPart.addTag('hexID','R85243')
newPart.addTag('ooPackageMarking','243')
newPart.addTag('oompDesc','O243')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O243-01")
