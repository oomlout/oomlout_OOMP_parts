...
newPart.addTag('oompID','RESE-0402-X-O134-01')
newPart.addTag('name','SMD (0402) 130k Ohm Resistor')
newPart.addTag('hexID','R42134')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O134-01")
