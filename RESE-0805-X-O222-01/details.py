...
newPart.addTag('oompID','RESE-0805-X-O222-01')
newPart.addTag('hexID','R85222')
newPart.addTag('ooPackageMarking','222')
newPart.addTag('oompDesc','O222')
newPart.addTag('name','SMD (0805) 2.2k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O222-01")
