...
newPart.addTag('oompID','RESE-0402-X-O471-01')
newPart.addTag('hexID','R42471')
newPart.addTag('oompDesc','O471')
newPart.addTag('name','SMD (0402) 470 Ohm Resistor')
newPart.addTag('oompSort','RESE0402O471')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O471-01")
