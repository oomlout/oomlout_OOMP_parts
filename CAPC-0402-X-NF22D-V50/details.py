...
newPart.addTag('oompID','CAPC-0402-X-NF22D-V50')
newPart.addTag('name','SMD (0402) 2.2 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42N002')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','NF22D')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-NF22D-V50")
