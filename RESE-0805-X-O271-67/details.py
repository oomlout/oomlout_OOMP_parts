...
newPart.addTag('oompID','RESE-0805-X-O271-67')
newPart.addTag('name','SMD (0805) 270 Ohm Resistor 1%')
newPart.addTag('hexID','R85271A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O271-67")
