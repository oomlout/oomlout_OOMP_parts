...
newPart.addTag('oompID','RESE-0603-X-O121-01')
newPart.addTag('name','SMD (0603) 120 Ohm Resistor')
newPart.addTag('hexID','R6120')
newPart.addTag('ooPackageMarking','120')
newPart.addTag('oompDesc','O120')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O120-01")
