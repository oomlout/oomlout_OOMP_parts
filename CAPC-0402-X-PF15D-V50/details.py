...
newPart.addTag('oompID','CAPC-0402-X-PF15D-V50')
newPart.addTag('name','SMD (0402) 1.5 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42P0015D')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF15D')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-PF15D-V50")
