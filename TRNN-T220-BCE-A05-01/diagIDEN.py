...
shiftX=50
shiftY=50
# TEMPLATE  template;XXXX-T220-X-XXXX-01-iden
...
text("Q1",(0,0),stroke_width=0.25,stroke='black',font_size='6pt',font_family='Relief Single Line Outline',text_align='center')
