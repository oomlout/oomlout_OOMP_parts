...
newPart.addTag('oompID','RESE-0402-X-O124-01')
newPart.addTag('name','SMD (0402) 120k Ohm Resistor')
newPart.addTag('hexID','R42124')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O124-01")
