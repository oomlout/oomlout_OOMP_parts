...
newPart.addTag('oompID','RESE-0805-X-O221-67')
newPart.addTag('name','SMD (0805) 220 Ohm Resistor 1%')
newPart.addTag('hexID','R85221A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O221-67")
