...
newPart.addTag('oompID','RESE-0603-X-O10X-67')
newPart.addTag('name','SMD (0603) 1 Ohm Resistor 1%')
newPart.addTag('hexID','R610XA')
newPart.addTag('oompDesc','O10X')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O10X-67")
