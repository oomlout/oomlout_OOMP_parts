...
newPart.addTag('oompID','CAPC-0402-X-UF10-V63D')
newPart.addTag('name','SMD (0402) 10 uF Capacitor (Ceramic) 6.3v')
newPart.addTag('hexID','C42U010')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-UF10-V63D")
