...
newPart.addTag('oompID','RESE-0603-X-O221-67')
newPart.addTag('name','SMD (0603) 220 Ohm Resistor 1%')
newPart.addTag('hexID','R6221A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O221-67")
