...
newPart.addTag('oompID','RESE-0402-X-O182-67')
newPart.addTag('name','SMD (0402) 1.8k Ohm Resistor 1%')
newPart.addTag('hexID','R42182A')
newPart.addTag('oompDesc','O182')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O182-67")
