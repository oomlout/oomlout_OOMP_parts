...
newPart.addTag('oompID','RESE-0805-X-O331-01')
newPart.addTag('name','SMD (0805) 330 Ohm Resistor')
newPart.addTag('hexID','R85331')
newPart.addTag('ooPackageMarking','331')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O331-01")
