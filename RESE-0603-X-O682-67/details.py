...
newPart.addTag('oompID','RESE-0603-X-O682-67')
newPart.addTag('name','SMD (0603) 6.8k Ohm Resistor 1%')
newPart.addTag('hexID','R6682A')
newPart.addTag('oompDesc','O682')
newPart.addTag('oompSort','RESE0603O682')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O682-67")
