...
newPart.addTag('oompID','RESE-0603-X-O22X-67')
newPart.addTag('name','SMD (0603) 2.2 Ohm Resistor 1%')
newPart.addTag('hexID','R622X')
newPart.addTag('oompDesc','O22X')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O22X-67")
