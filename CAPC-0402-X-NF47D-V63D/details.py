...
newPart.addTag('oompID','CAPC-0402-X-NF47D-V63D')
newPart.addTag('name','SMD (0402) 4.7 nF Capacitor (Ceramic) 6.3v')
newPart.addTag('hexID','C42N047V63D')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-NF47D-V63D")
