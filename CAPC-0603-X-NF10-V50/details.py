...
newPart.addTag('oompID','CAPC-0603-X-NF10-V50')
newPart.addTag('name','SMD (0603) 10 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6N010')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-NF10-V50")
