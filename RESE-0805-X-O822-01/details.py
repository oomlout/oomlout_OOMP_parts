...
newPart.addTag('oompID','RESE-0805-X-O822-01')
newPart.addTag('name','SMD (0805) 8.2k Ohm Resistor')
newPart.addTag('ooPackageMarking','822')
newPart.addTag('hexID','R85822')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O822-01")
