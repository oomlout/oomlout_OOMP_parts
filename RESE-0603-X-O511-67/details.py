...
newPart.addTag('oompID','RESE-0603-X-O511-67')
newPart.addTag('name','SMD (0603) 510 Ohm Resistor 1%')
newPart.addTag('hexID','R6511A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O511-67")
