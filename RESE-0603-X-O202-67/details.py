...
newPart.addTag('oompID','RESE-0603-X-O202-67')
newPart.addTag('name','SMD (0603) 2k Ohm Resistor 1%')
newPart.addTag('hexID','R6202A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O202-67")
