...
newPart.addTag('oompDesc','PI2X12')
newPart.addTag('oompIndex','RS')
newPart.addTag('oompVersion','999')
newPart.addTag('hexID','HRS2X12')
newPart.addTag('ooPitch','2.54 mm')
newPart.addTag('ooWidth','30.48 mm')
newPart.addTag('ooHeight','5.08 mm')
newPart.addTag('ooLength','17.66 mm')
newPart.addTag('numPins','24')
newPart.addTag('numRows','2')
newPart.addTag('oompFootprint','HEAD-I01-X-PI2x12-RS')
newPart = OOMPtags.addTags(newPart,"HEAD-I01-X-PI2X12-RS",pitch = 2.54 )
