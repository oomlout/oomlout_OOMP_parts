...
newPart.addTag('oompID','RESE-0603-X-O560-01')
newPart.addTag('name','SMD (0603) 56 Ohm Resistor')
newPart.addTag('hexID','R6560')
newPart.addTag('ooPackageMarking','560')
newPart.addTag('oompDesc','O560')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O560-01")
