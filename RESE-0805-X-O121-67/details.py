...
newPart.addTag('oompID','RESE-0805-X-O121-67')
newPart.addTag('name','SMD (0805) 120 Ohm Resistor 1%')
newPart.addTag('hexID','R85121A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O121-67")
