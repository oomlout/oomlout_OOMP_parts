...
newPart.addTag('oompID','RESE-0402-X-O103-67')
newPart.addTag('hexID','R42103A')
newPart.addTag('oompDesc','O103')
newPart.addTag('name','SMD (0402) 10k Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O103')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O103-67")
