...
newPart.addTag('oompID','RESE-0603-X-O105-67')
newPart.addTag('name','SMD (0603) 1M Ohm Resistor 1%')
newPart.addTag('hexID','R6105A')
newPart.addTag('oompDesc','O105')
newPart.addTag('oompSort','06031000000')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O105-67")
