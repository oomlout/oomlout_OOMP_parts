...
newPart.addTag('oompID','RESE-0805-X-O392-67')
newPart.addTag('name','SMD (0805) 3.9k Ohm Resistor 1%')
newPart.addTag('hexID','R85392A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O392-67")
