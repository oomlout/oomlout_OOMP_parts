...
newPart.addTag('oompID','RESE-0805-X-O330-67')
newPart.addTag('name','SMD (0805) 33 Ohm Resistor 1%')
newPart.addTag('hexID','R85330A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O330-67")
