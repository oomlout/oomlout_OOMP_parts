...
newPart.addTag('oompID','CAPC-0603-X-PF100-V50')
newPart.addTag('name','SMD (0603) 100 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P100')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF100-V50")
