...
newPart.addTag('oompID','CAPC-0603-X-PF15-V50')
newPart.addTag('name','SMD (0603) 15 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P015')
newPart.addTag('oompSort','')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF15')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF15-V50",pins = 2)
