...
newPart.addTag('oompID','RESE-0805-X-O511-01')
newPart.addTag('name','SMD (0805) 510 Ohm Resistor')
newPart.addTag('hexID','R85511')
newPart.addTag('ooPackageMarking','511')
newPart.addTag('oompDesc','O511')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O511-01")
