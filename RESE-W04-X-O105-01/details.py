...
newPart.addTag('index','4149')
newPart.addTag('oompID','RESE-W04-X-O105-01')
newPart.addTag('name','1/4 Watt 1M Ohm Resistor')
newPart.addTag('hexID','R4105')
newPart.addTag('oompSort','0W041000000')
...
newPart.addTag('colorBand3','GREEN')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O105-01")
