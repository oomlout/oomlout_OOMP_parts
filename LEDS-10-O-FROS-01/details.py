...
pitch = 2.54 
newPart.addTag('index','3975')
newPart.addTag('oompID','LEDS-10-O-FROS-01')
newPart.addTag('name','10 mm Frosted Orange LED')
newPart.addTag('hexID','L10O')
newPart.addTag('oompSort','1010O')
...
newPart.addTag('ooWavelength','604 nm')
...
newPart = OOMPtags.addTags(newPart,"LEDS-10-O-FROS-01",pitch = 2.54 )
