...
newPart.addTag('oompID','RESE-0402-X-O512-01')
newPart.addTag('name','SMD (0402) 5.1k Ohm Resistor')
newPart.addTag('hexID','R42512')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O512-01")
