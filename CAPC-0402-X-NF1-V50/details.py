...
newPart.addTag('oompID','CAPC-0402-X-NF1-V50')
newPart.addTag('name','SMD (0402) 1 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42N001')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','NF1')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-NF1-V50")
