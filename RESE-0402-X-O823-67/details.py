...
newPart.addTag('oompID','RESE-0402-X-O823-67')
newPart.addTag('name','SMD (0402) 82k Ohm Resistor 1%')
newPart.addTag('hexID','R42823A')
newPart.addTag('oompDesc','O823')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O823-67")
