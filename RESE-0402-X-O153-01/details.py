...
newPart.addTag('oompID','RESE-0402-X-O153-01')
newPart.addTag('name','SMD (0402) 15k Ohm Resistor')
newPart.addTag('hexID','R42153')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O153-01")
