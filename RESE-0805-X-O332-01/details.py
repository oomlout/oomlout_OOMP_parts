...
newPart.addTag('oompID','RESE-0805-X-O332-01')
newPart.addTag('hexID','R85332')
newPart.addTag('ooPackageMarking','332')
newPart.addTag('oompDesc','O332')
newPart.addTag('name','SMD (0805) 3.3k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O332-01")
