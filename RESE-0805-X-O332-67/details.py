...
newPart.addTag('oompID','RESE-0805-X-O332-67')
newPart.addTag('name','SMD (0805) 3.3k Ohm Resistor 1%')
newPart.addTag('hexID','R85332A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O332-67")
