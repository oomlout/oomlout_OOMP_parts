...
newPart.addTag('oompID','RESE-0402-X-O499D-67')
newPart.addTag('hexID','R42499A')
newPart.addTag('oompDesc','O499D')
newPart.addTag('name','SMD (0402) 49.9 Ohm Resistor 1%')
newPart.addTag('oompSort','RESE0402O499D')
...
newPart.addTag('ooHeight','0.35mm')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O499D-67")
