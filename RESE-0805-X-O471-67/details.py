...
newPart.addTag('oompID','RESE-0805-X-O471-67')
newPart.addTag('name','SMD (0805) 470 Ohm Resistor 1%')
newPart.addTag('hexID','R85471A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O471-67")
