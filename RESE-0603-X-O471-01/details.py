...
newPart.addTag('oompID','RESE-0603-X-O471-01')
newPart.addTag('hexID','R6471')
newPart.addTag('hexID','R6471')
newPart.addTag('name','SMD (0603) 470 Ohm Resistor')
newPart.addTag('ooPackageMarking','471')
newPart.addTag('oompDesc','O471')
newPart.addTag('oompSort','RESE0603O471')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O471-01")
