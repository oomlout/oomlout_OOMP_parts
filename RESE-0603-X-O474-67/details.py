...
newPart.addTag('oompID','RESE-0603-X-O474-67')
newPart.addTag('name','SMD (0603) 470k Ohm Resistor 1%')
newPart.addTag('hexID','R6474A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O474-67")
