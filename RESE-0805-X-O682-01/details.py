...
newPart.addTag('oompID','RESE-0805-X-O682-01')
newPart.addTag('name','SMD (0805) 6.8k Ohm Resistor')
newPart.addTag('hexID','R85682')
newPart.addTag('ooPackageMarking','682')
newPart.addTag('oompDesc','O682')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O682-01")
