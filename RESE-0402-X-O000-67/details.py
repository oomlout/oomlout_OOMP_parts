...
newPart.addTag('oompID','RESE-0402-X-O000-67')
newPart.addTag('name','SMD (0402) 0 Ohm Resistor 1%')
newPart.addTag('hexID','R42000A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O000-67")
