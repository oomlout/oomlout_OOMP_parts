...
newPart.addTag('oompID','RESE-0603-X-O562-67')
newPart.addTag('name','SMD (0603) 5.6k Ohm Resistor 1%')
newPart.addTag('hexID','R6562A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O562-67")
