...
newPart.addTag('oompID','RESE-0603-X-O4990-67')
newPart.addTag('name','SMD (0603) 499 Ohm Resistor 1%')
newPart.addTag('hexID','R64990A')
newPart.addTag('oompDesc','O4990')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O4990-67")
