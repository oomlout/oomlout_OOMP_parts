...
newPart.addTag('oompID','RESE-0603-X-O513-67')
newPart.addTag('name','SMD (0603) 51k Ohm Resistor 1%')
newPart.addTag('hexID','R6513A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O513-67")
