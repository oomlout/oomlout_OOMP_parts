...
newPart.addTag('oompID','RESE-0603-X-O223-01')
newPart.addTag('name','SMD (0603) 22k Ohm Resistor')
newPart.addTag('hexID','R6223')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O223-01")
