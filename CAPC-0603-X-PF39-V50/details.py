...
newPart.addTag('oompID','CAPC-0603-X-PF39-V50')
newPart.addTag('name','SMD (0603) 39 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P039')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF39')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF39-V50")
