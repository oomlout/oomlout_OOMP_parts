...
newPart.addTag('oompID','CAPC-0402-X-PF22-V50')
newPart.addTag('name','SMD (0402) 22 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42P022')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-PF22-V50")
