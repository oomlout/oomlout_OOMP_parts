...
newPart.addTag('oompID','RESE-0402-X-O512-67')
newPart.addTag('name','SMD (0402) 5.1k Ohm Resistor 1%')
newPart.addTag('hexID','R42512A')
newPart.addTag('oompDesc','O512')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O512-67")
