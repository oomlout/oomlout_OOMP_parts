...
newPart.addTag('oompID','CAPC-0402-X-NF47-V25')
newPart.addTag('name','SMD (0402) 47 nF Capacitor (Ceramic) 25v')
newPart.addTag('hexID','C42N047')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','NF47')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-NF47-V25")
