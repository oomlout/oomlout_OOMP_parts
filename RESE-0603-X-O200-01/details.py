...
newPart.addTag('oompID','RESE-0603-X-O200-01')
newPart.addTag('name','SMD (0603) 20 Ohm Resistor')
newPart.addTag('hexID','R6200')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O200-01")
