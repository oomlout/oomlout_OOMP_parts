...
newPart.addTag('oompID','RESE-0603-X-O182-67')
newPart.addTag('name','SMD (0603) 1.8k Ohm Resistor 1%')
newPart.addTag('hexID','R6182A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O182-67")
