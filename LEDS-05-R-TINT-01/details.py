...
newPart.addTag('oompID','LEDS-05-R-TINT-01')
newPart.addTag('name','5 mm Tinted Red LED')
newPart.addTag('hexID','LT5R')
newPart.addTag('oompSort','0505ZTINTR')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-R-TINT-01")
