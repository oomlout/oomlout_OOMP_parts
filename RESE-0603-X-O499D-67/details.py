...
newPart.addTag('oompID','RESE-0603-X-O499D-67')
newPart.addTag('name','SMD (0603) 49.9 Ohm Resistor 1%')
newPart.addTag('hexID','R6499DA')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O499D-67")
