...
newPart.addTag('oompID','RESE-0805-X-O303-01')
newPart.addTag('name','SMD (0805) 30k Ohm Resistor')
newPart.addTag('hexID','R85303')
newPart.addTag('ooPackageMarking','303')
newPart.addTag('oompDesc','O303')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O303-01")
