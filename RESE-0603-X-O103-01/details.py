...
newPart.addTag('oompID','RESE-0603-X-O103-01')
newPart.addTag('name','SMD (0603) 10k Ohm Resistor')
newPart.addTag('hexID','R6103')
newPart.addTag('ooPackageMarking','103')
newPart.addTag('oompDesc','O103')
newPart.addTag('oompSort','RESE0603O103')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O103-01")
