...
newPart.addTag('oompID','RESE-0603-X-O124-67')
newPart.addTag('name','SMD (0603) 120k Ohm Resistor 1%')
newPart.addTag('hexID','R6124A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O124-67")
