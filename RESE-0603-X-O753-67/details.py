...
newPart.addTag('oompID','RESE-0603-X-O753-67')
newPart.addTag('name','SMD (0603) 75k Ohm Resistor 1%')
newPart.addTag('hexID','R6753A')
newPart.addTag('oompDesc','O753')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O753-67")
