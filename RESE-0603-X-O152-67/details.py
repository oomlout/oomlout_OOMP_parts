...
newPart.addTag('oompID','RESE-0603-X-O152-67')
newPart.addTag('name','SMD (0603) 1.5k Ohm Resistor 1%')
newPart.addTag('hexID','R6152A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O152-67")
