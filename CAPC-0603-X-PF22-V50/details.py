...
newPart.addTag('oompID','CAPC-0603-X-PF22-V50')
newPart.addTag('name','SMD (0603) 22 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6P022')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-PF22-V50")
