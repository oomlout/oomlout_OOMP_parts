...
newPart.addTag('oompID','LEDS-05-V-TINT-01')
newPart.addTag('name','5 mm Tinted Purple LED')
newPart.addTag('hexID','LT5V')
newPart.addTag('oompSort','0505ZTINTV')
newPart.addTag('oompType','LEDS')
newPart.addTag('oompSize','05')
newPart.addTag('oompColor','V')
newPart.addTag('oompDesc','TINT')
...
newPart = OOMPtags.addTags(newPart,"LEDS-05-V-TINT-01")
