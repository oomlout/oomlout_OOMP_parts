...
newPart.addTag('oompID','RESE-0805-X-O103-01')
newPart.addTag('name','SMD (0805) 10k Ohm Resistor')
newPart.addTag('ooPackageMarking','103')
newPart.addTag('hexID','R85103')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O103-01")
