...
newPart.addTag('oompID','RESE-0805-X-O121-01')
newPart.addTag('hexID','R85121')
newPart.addTag('ooPackageMarking','121')
newPart.addTag('oompDesc','O121')
newPart.addTag('name','SMD (0805) 120 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O121-01")
