...
newPart.addTag('index','4087')
newPart.addTag('oompID','CAPT-1210-X-UF10-V10')
newPart.addTag('name','SMD (1210) 10 uF Capacitor (Tantalum) 10v')
newPart.addTag('hexID','CTS2U010B')
newPart.addTag('oompSort','12100.00001000000000')
...
newPart.addTag('ooManufacturerPartNumber','TAJB106K010RNJ')
newPart.addTag('ooMaxVoltage','10 V')
newPart.addTag('ooTolerance','10%')
newPart.addTag('ooSEEEDsku','302020019')
...
newPart = OOMPtags.addTags(newPart,"CAPT-1210-X-UF10-V10")
