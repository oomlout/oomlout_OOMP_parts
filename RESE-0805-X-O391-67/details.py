...
newPart.addTag('oompID','RESE-0805-X-O391-67')
newPart.addTag('name','SMD (0805) 390 Ohm Resistor 1%')
newPart.addTag('hexID','R85391A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O391-67")
