...
newPart.addTag('oompID','RESE-0402-X-O151-67')
newPart.addTag('name','SMD (0402) 150 Ohm Resistor 1%')
newPart.addTag('hexID','R42151A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O151-67")
