...
newPart.addTag('oompID','RESE-0402-X-O121-01')
newPart.addTag('name','SMD (0402) 120 Ohm Resistor')
newPart.addTag('hexID','R42121')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O121-01")
