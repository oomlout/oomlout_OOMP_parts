...
newPart.addTag('oompID','RESE-0402-X-O181-01')
newPart.addTag('name','SMD (0402) 180 Ohm Resistor')
newPart.addTag('hexID','R42181')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O181-01")
