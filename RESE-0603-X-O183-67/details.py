...
newPart.addTag('oompID','RESE-0603-X-O183-67')
newPart.addTag('name','SMD (0603) 18k Ohm Resistor 1%')
newPart.addTag('hexID','R6183A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O183-67")
