...
newPart.addTag('oompID','RESE-0603-X-O362-01')
newPart.addTag('name','SMD (0603) 3.6k Ohm Resistor')
newPart.addTag('hexID','R6362')
newPart.addTag('ooPackageMarking','362')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O362')
