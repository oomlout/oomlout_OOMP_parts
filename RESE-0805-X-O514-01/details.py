...
newPart.addTag('oompID','RESE-0805-X-O514-01')
newPart.addTag('name','SMD (0805) 510k Ohm Resistor')
newPart.addTag('hexID','R85514')
newPart.addTag('ooPackageMarking','514')
newPart.addTag('oompDesc','O514')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O514-01")
