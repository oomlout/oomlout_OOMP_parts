...
newPart.addTag('oompID','RESE-0603-X-O510-67')
newPart.addTag('name','SMD (0603) 51 Ohm Resistor 1%')
newPart.addTag('hexID','R6510A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O510-67")
