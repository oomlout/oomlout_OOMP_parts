...
newPart.addTag('index','4165')
newPart.addTag('oompID','RESE-W04-X-O47X-01')
newPart.addTag('name','1/4 Watt 4.7 Ohm Resistor')
newPart.addTag('hexID','R447A')
newPart.addTag('oompSort','0W040000004')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','W04')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O47X')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O47X-01")
