...
newPart.addTag('oompID','RESE-0402-X-O101-01')
newPart.addTag('hexID','R42101')
newPart.addTag('oompDesc','O101')
newPart.addTag('name','SMD (0402) 100 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O101-01")
