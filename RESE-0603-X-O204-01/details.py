...
newPart.addTag('oompID','RESE-0603-X-O204-01')
newPart.addTag('name','SMD (0603) 200k Ohm Resistor')
newPart.addTag('hexID','R6204')
newPart.addTag('ooPackageMarking','204')
newPart.addTag('oompDesc','O204')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O204-01")
