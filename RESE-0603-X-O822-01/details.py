...
newPart.addTag('oompID','RESE-0603-X-O822-01')
newPart.addTag('name','SMD (0603) 8.2k Ohm Resistor')
newPart.addTag('hexID','R6822')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O822-01")
