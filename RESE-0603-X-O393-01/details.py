...
newPart.addTag('oompID','RESE-0603-X-O393-01')
newPart.addTag('name','SMD (0603) 39k Ohm Resistor')
newPart.addTag('hexID','R6393')
newPart.addTag('ooPackageMarking','393')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O393')
