...
newPart.addTag('oompID','RESE-0402-X-O332-01')
newPart.addTag('hexID','R42332')
newPart.addTag('oompDesc','O332')
newPart.addTag('name','SMD (0402) 3.3k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O332-01")
