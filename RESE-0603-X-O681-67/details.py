...
newPart.addTag('oompID','RESE-0603-X-O681-67')
newPart.addTag('name','SMD (0603) 680 Ohm Resistor 1%')
newPart.addTag('hexID','R6681A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O681-67")
