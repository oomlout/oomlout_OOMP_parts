...
newPart.addTag('oompID','RESE-0603-X-O432-67')
newPart.addTag('name','SMD (0603) 4.3k Ohm Resistor 1%')
newPart.addTag('hexID','R6432A')
newPart.addTag('oompDesc','O432')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O432-67")
