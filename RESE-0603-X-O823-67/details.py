...
newPart.addTag('oompID','RESE-0603-X-O823-67')
newPart.addTag('name','SMD (0603) 82k Ohm Resistor 1%')
newPart.addTag('hexID','R6823A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O823-67")
