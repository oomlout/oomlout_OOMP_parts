...
newPart.addTag('oompID','RESE-0603-X-O470-01')
newPart.addTag('name','SMD (0603) 47 Ohm Resistor')
newPart.addTag('hexID','R6470')
newPart.addTag('ooPackageMarking','470')
newPart.addTag('oompDesc','O470')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O470-01")
