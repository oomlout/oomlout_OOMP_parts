...
newPart.addTag('oompID','RESE-0805-X-O000-67')
newPart.addTag('name','SMD (0805) 0 Ohm Resistor 1%')
newPart.addTag('hexID','R85000A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O000-67")
