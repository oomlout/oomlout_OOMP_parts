...
newPart.addTag('oompID','CAPC-0402-X-PF12-V50')
newPart.addTag('name','SMD (0402) 12 pF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C42P012')
newPart.addTag('oompType','CAPC')
newPart.addTag('oompSize','0402')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','PF12')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0402-X-PF12-V50")
