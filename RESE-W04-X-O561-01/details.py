...
newPart.addTag('index','3981')
newPart.addTag('oompID','RESE-W04-X-O561-01')
newPart.addTag('name','1/4 Watt 560 Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-W04-X-O561-01")
