// Generated by SolidPython 1.1.3 on 2022-06-12 19:23:15
$fn = 48;
	...
	union() {
		translate(v = [0, 0, 0]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
						translate(v = [3.8100000000, 0, 1.5500000000]) {
							rotate(a = [0, 0, 0]) {
								color(alpha = 1.0000000000, c = "gray") {
									translate(v = [0, 0, 0]) {
										rotate(a = [0, 0, 0]) {
											translate(v = [0, 0, -3.2750000000]) {
												cube(center = true, size = [0.6000000000, 0.6000000000, 6.5500000000]);
											}
										}
									}
								}
									...
									translate(v = [0, 0, 0]) {
										rotate(a = [0, 0, 0]) {
											translate(v = [0, 0, -3.8100000000]) {
												cube(center = true, size = [0.6000000000, 0.6000000000, 7.6200000000]);
											}
										}
									}
								}
