...
newPart.addTag('oompID','RESE-0805-X-O563-67')
newPart.addTag('name','SMD (0805) 56k Ohm Resistor 1%')
newPart.addTag('hexID','R85563A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O563-67")
