...
newPart.addTag('oompID','RESE-0805-X-O242-01')
newPart.addTag('name','SMD (0805) 2.4k Ohm Resistor')
newPart.addTag('hexID','R85242')
newPart.addTag('ooPackageMarking','242')
newPart.addTag('oompDesc','O242')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O242-01")
