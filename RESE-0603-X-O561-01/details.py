...
newPart.addTag('oompID','RESE-0603-X-O561-01')
newPart.addTag('name','SMD (0603) 560 Ohm Resistor')
newPart.addTag('hexID','R6561')
newPart.addTag('ooPackageMarking','561')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O561-01")
