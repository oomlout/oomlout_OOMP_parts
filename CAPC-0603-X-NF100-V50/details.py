...
newPart.addTag('oompID','CAPC-0603-X-NF100-V50')
newPart.addTag('name','SMD (0603) 100 nF Capacitor (Ceramic) 50v')
newPart.addTag('hexID','C6N100')
...
newPart = OOMPtags.addTags(newPart,"CAPC-0603-X-NF100-V50")
