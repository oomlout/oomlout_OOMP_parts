...
newPart.addTag('oompID','RESE-0603-X-O361-01')
newPart.addTag('name','SMD (0603) 360 Ohm Resistor')
newPart.addTag('hexID','R6361')
newPart.addTag('ooPackageMarking','361')
newPart.addTag('oompType','RESE')
newPart.addTag('oompSize','0603')
newPart.addTag('oompColor','X')
newPart.addTag('oompDesc','O361')
