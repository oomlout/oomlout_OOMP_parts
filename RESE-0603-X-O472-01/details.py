...
newPart.addTag('oompID','RESE-0603-X-O472-01')
newPart.addTag('hexID','R6472')
newPart.addTag('hexID','R6472')
newPart.addTag('name','SMD (0603) 4.7k Ohm Resistor')
newPart.addTag('ooPackageMarking','472')
newPart.addTag('oompDesc','O472')
newPart.addTag('oompSort','06030004700')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O472-01")
