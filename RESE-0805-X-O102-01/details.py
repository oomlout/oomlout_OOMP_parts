...
newPart.addTag('oompID','RESE-0805-X-O102-01')
newPart.addTag('hexID','R85102')
newPart.addTag('ooPackageMarking','102')
newPart.addTag('oompDesc','O102')
newPart.addTag('name','SMD (0805) 1k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O102-01")
