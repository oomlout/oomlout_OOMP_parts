...
newPart.addTag('oompID','RESE-0402-X-O123-67')
newPart.addTag('name','SMD (0402) 12k Ohm Resistor 1%')
newPart.addTag('hexID','R42123A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O123-67")
