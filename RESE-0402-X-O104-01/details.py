...
newPart.addTag('oompID','RESE-0402-X-O104-01')
newPart.addTag('hexID','R42104')
newPart.addTag('oompDesc','O104')
newPart.addTag('name','SMD (0402) 110k Ohm Resistor')
...
newPart = OOMPtags.addTags(newPart,"RESE-0402-X-O104-01")
