...
newPart.addTag('oompID','RESE-0603-X-O821-67')
newPart.addTag('name','SMD (0603) 820 Ohm Resistor 1%')
newPart.addTag('hexID','R6821A')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O821-67")
