...
newPart.addTag('oompID','RESE-0805-X-O750-67')
newPart.addTag('name','SMD (0805) 75 Ohm Resistor 1%')
newPart.addTag('hexID','R85750A')
newPart.addTag('oompDesc','O750')
...
newPart = OOMPtags.addTags(newPart,"RESE-0805-X-O750-67")
