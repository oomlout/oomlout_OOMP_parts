...
newPart.addTag('oompID','RESE-0603-X-O4992-67')
newPart.addTag('name','SMD (0603) 49.9k Ohm Resistor 1%')
newPart.addTag('hexID','R64992A')
newPart.addTag('oompDesc','O4992')
...
newPart = OOMPtags.addTags(newPart,"RESE-0603-X-O4992-67")
